			...
			<form action="./procesa_bitacora.php" method="POST">
				...
				<label for="asunto"><strong>Seleccione el tipo de cambio</strong></label>
					<div class="form-check" name="tipo_cambio">
					  <input class="form-check-input" type="radio" name="tipo_cambio" value="Cambio Urgente" id="flexRadioDefault1">
					  <label class="form-check-label" for="flexRadioDefault1">
						Cambio Urgente
					  </label>
					</div>
					<div class="form-check">
					  <input class="form-check-input" type="radio" name="Cambio Normal" id="flexRadioDefault2" >
					  <label class="form-check-label" for="flexRadioDefault2">
						Cambio Normal
					  </label>
					</div>
					<div class="form-check">
					  <input class="form-check-input" type="radio" name="Cambio Estandar" id="flexRadioDefault2" >
					  <label class="form-check-label" for="flexRadioDefault2">
						Cambio Estandar
					  </label>
					</div>
